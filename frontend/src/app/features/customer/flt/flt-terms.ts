    ...
    <div class="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 py-8">
      <div class="bg-white dark:bg-zinc-800/60 rounded-2xl border border-gray-100 dark:border-zinc-700 shadow-sm p-6 sm:p-10 flex flex-col gap-8">
        ...
        <div class="flex flex-col gap-2">
          <p class="text-xs text-gray-400 dark:text-zinc-500 uppercase tracking-widest font-bold">Lyceum of the Philippines University</p>
          <h2 class="text-2xl font-black text-gray-900 dark:text-zinc-100">FLT Theater — Terms and Conditions</h2>
          <p class="text-sm text-gray-500 dark:text-zinc-400 leading-relaxed">
            These Terms and Conditions govern the reservation and use of the Faculty Learning and Training (FLT) Theater facility at Lyceum of the Philippines University. By submitting a reservation request, you agree to comply fully with the policies stated herein.
          </p>
        </div>

        <!-- Section 1 -->
        <section class="flex flex-col gap-3">
          <h3 class="flex items-center gap-2 text-base font-bold text-gray-800 dark:text-zinc-200">
          ...
          <ul class="flex flex-col gap-1.5 text-sm text-gray-600 dark:text-zinc-400 list-none pl-9">
        ...
        <section class="flex flex-col gap-3">
          ...
          <ul class="flex flex-col gap-1.5 text-sm text-gray-600 dark:text-zinc-400 list-none pl-9">
            <li class="flex gap-2"><ui-icon name="circle" class="text-[8px] text-primary mt-1.5 shrink-0" /> All reservation requests must be submitted at least <strong class="text-gray-800 dark:text-zinc-200">fourteen (14) calendar days</strong> before the intended date of use.</li>
        ...
        <section class="flex flex-col gap-3">
          ...
          <ul class="flex flex-col gap-1.5 text-sm text-gray-600 dark:text-zinc-400 list-none pl-9">
            ...
            <li class="flex gap-2"><ui-icon name="circle" class="text-[8px] text-primary mt-1.5 shrink-0" /> <strong class="text-gray-800 dark:text-zinc-200">FLT Theater</strong> — Maximum 300 pax.</li>
            <li class="flex gap-2"><ui-icon name="circle" class="text-[8px] text-primary mt-1.5 shrink-0" /> <strong class="text-gray-800 dark:text-zinc-200">Amphitheater</strong> — Maximum 150 pax.</li>
            <li class="flex gap-2"><ui-icon name="circle" class="text-[8px] text-primary mt-1.5 shrink-0" /> <strong class="text-gray-800 dark:text-zinc-200">Banquet Hall</strong> — Maximum 100 pax.</li>
        ...
        <section class="flex flex-col gap-3">
          ...
          <ul class="flex flex-col gap-1.5 text-sm text-gray-600 dark:text-zinc-400 list-none pl-9">
            <li class="flex gap-2"><ui-icon name="circle" class="text-[8px] text-primary mt-1.5 shrink-0" /> Cancellations must be formally communicated to the FLT Administration at least <strong class="text-gray-800 dark:text-zinc-200">three (3) business days</strong> before the scheduled event.</li>
        ...
        <!-- Footer -->
        <div class="rounded-xl bg-gray-50 dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 p-4 flex flex-col gap-2">
