...
const BASE =
  'inline-flex box-border items-center justify-center gap-1.5 rounded-md border ' +
  'h-9 px-3.5 text-sm font-medium leading-none ' +
  'shadow-[0_1px_1px_rgb(24_24_27/0.08),0_2px_5px_-3px_rgb(24_24_27/0.16)] dark:shadow-[0_1px_1px_rgb(0_0_0/0.35),0_2px_5px_-3px_rgb(0_0_0/0.5)] ' +
