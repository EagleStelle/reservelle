...
public class UserManagementController {
	...
	public AccountStatementResponse createAccountcreateAccount(@RequestHeader("Authorization") String authHeader,
	...
	public AccountStatementResponse deleteUserAccount(@RequestHeader("Authorization") String authHeader,
			@RequestBody DeleteUserRequest user) {

		return userService.deleteAccountbyEmpId(authHeader, user);
